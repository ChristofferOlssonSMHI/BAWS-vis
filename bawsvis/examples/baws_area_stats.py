...
if __name__ == "__main__":
    # "POLY_NAMN"
    areas = gp.read_file(
        r'C:\Temp\shapes\helcom_coclime\HELCOM_subbasins_2018_baws_use.shp'
    ...
    boolean_filter = areas['POLY_NAMN'].isin(selected_basins)
    ...
    for YEAR in range(2002, 2023):
        ...
        directory = r'C:\Temp\baws_reanalys\2022\corrected_geoms\clipped_archive' \
            if YEAR == 2022 else r'C:\Temp\baws_reanalys\clipped_archive\corrected_geoms'
        ...
        for cyano_fid in files:
            ...
            for v in (2, 3, 1):
                ...
                touched_areas = areas['POLY_NAMN'].iloc[indices]
